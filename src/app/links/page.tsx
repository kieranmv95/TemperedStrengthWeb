...
function TikTokGlyph({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.88-2.89 2.89 2.89 0 012.88-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.3a6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V8.73a8.18 8.18 0 004.76 1.52V6.79a4.84 4.84 0 01-1-.1z" />
    </svg>
  );
}
        ...
        <div className="space-y-8">
          ...
          <section aria-labelledby="rest-heading">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href={TIKTOK_URL} target="_blank" rel="noopener noreferrer" className={linkRowClassName()}>
                  <TikTokGlyph className="w-6 h-6 shrink-0 text-white" />
                  <span className="flex min-w-0 flex-1 flex-col gap-0.5 text-left">
                    <span className="font-semibold text-white">Tempered Strength on TikTok</span>
                    <span className="text-xs text-neutral-500 truncate">@temperedstrength</span>
                  </span>
                  <ExternalArrow className="w-5 h-5 shrink-0 text-neutral-500 group-hover:text-[#c9b072]" />
                </a>
